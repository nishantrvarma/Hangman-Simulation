...
def startGame():
    ...
    while (data['status'] != "DEAD"):
        ...
        if data['state'].count('_') < 2 and data['remaining_guesses'] == 1:     #When there are few chances left and dashes are small in number, program prompts user to finish the guesses.
